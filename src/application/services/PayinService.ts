...
export class PayinService {
    ...
    async execute(
        ...
        const selectedGateway = await this.selectGateway(
            command,
            paymentMethod,
            paymentIntent,
            currency,
    ...
    private async validateRequest(command: CreatePayinCommand): Promise<void> {
    ...
    /**
     * Executes gateway payin operation.
     * 
    ...
    /**
     * Emits canonical events for payin execution.
     * 
